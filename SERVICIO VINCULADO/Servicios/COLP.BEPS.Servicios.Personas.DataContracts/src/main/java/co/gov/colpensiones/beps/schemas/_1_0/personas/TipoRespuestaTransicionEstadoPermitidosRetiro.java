...
@XmlType(name = "tipoRespuestaTransicionEstadoPermitidosRetiro", propOrder = { "tipoEstado", "tipoOperacion" })
public class TipoRespuestaTransicionEstadoPermitidosRetiro {
