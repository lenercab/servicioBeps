 ...
 *
 */
public class BLRealizarCambioEstadoRetiro {
     ...
     */
    public BLRealizarCambioEstadoRetiro(LoggerBeps log) {
        ...
        if (informacionEntradaCambioEstado != null) {
            ...
            if (informacionEntradaCambioEstado.size() > Constantes.NUMERO_MAXIMO_PERMITIDO_REGISTROS) {
                ...
                if (listaNumeroDocumento.length() > 0) {
                    ...
                    List<TransicionesEstadoPermitidasDTO> transicionesPermitidas = daCambioEstado.transicionesEstadoPermitidasRetiro();
